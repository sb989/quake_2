...
/* precache */ "misc/power2.wav misc/power1.wav"
	...
	/*
		{
			...
			//"models/weapons/stunblade/stunblade.md2",
	...
	*/
	...
	
	{
		...
		//pickup sound
			"misc/w_pkup.wav",
			//world model,world model flags
			"models/weapons/stunblade/stunblade.md2",0,
			//view model
			"models/weapons/stunblade/stunblade.md2",
			//icon
			"w_blaster",
...
*/

	{
		...
		Weapon_Net,
		"misc/w_pkup.wav",
		"models/weapons/net/net.md2",NULL,
		"models/weapons/net/net.md2",
///* icon */	
"w_shotgun",
///* pickup */	
"Shotgun",
